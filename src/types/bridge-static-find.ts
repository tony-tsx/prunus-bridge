...
export type FindOneOptions<
    E extends AnyTarget> = TypeORM.FindOneOptions<Extract.Entity<E>>

export type FindManyOptions<
    E extends AnyTarget> = TypeORM.FindManyOptions<Extract.Entity<E>>

export type FindConditions<
    E extends AnyTarget> = TypeORM.FindConditions<Extract.Entity<E>>
