...
export interface GetterSetterStatic<E extends AnyTarget, S, I, V> {
  get( this: BridgeStatic<E, S, I> ): V
  set( this: BridgeStatic<E, S, I>, value: V ): void
  [GETTER_SETTER_ACCESS]: true
}

export interface GetterSetterInstance<E extends AnyTarget, S, I, V> {
...
export interface BridgeGetterSetterInstance<V> {
  <E extends AnyTarget, S, I>( bridge: BridgeInstance<E, S, I> ): GetterSetterInstance<E, S, I, V>
}

export interface BridgeGetterSetterStatic<V> {
  <E extends AnyTarget, S, I>( bridge: BridgeStatic<E, S, I> ): GetterSetterStatic<E, S, I, V>
}
